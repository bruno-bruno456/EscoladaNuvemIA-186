...
PROFILE_NAME = os.environ.get('AWS_PROFILE', 'BRSAO186')

def get_boto3_client(service_name, region_name='us-east-1', profile_name='BRSAO186'):
    """
...
def generate_chat_prompt(user_message, conversation_history=None, context=""):
    ...
    """
    system_prompt = """
    Você é um assistente virtual especialista em AWS, mais especificamente um Golden Jacket. 
    Você fornecerá dicas, auxílio, instruções, consultorias e métodos de estudos específicos a partir de seu conhecimento.
    """
